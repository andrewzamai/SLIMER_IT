"""
Evaluating SLIMER-EN Llama-2-7B for zero-shot NER on Italian datasets
...
if __name__ == '__main__':
    ...
    #model_path_or_name = f"./merged_models/llama2_7B_{args.number_pos_samples_per_NE}pos_{args.number_neg_samples_per_NE}neg_perNE_top{args.number_NEs}NEs_{args.with_guidelines}Def-IT"
    model_path_or_name = "expertai/SLIMER"
